...
/* suratları ekliyoruz bootstrap üzerinden*/
const SMILE = `
...
/*değikenleri belirledik */
let examGrade = prompt("Puani Girin")
let textInfo;
let info = document.querySelector("#info")
/* notun aralığını sınırlamak için kullandık */
/*suratları eklemek için textInfo ve += kullandık */
/* CLASS İÇİN İNFO içinde ekledik */
...
/*text-primary sınıfını remove ile silip text-danger ekledik */

info.innerHTML = `${textInfo} , ${examGrade}` 
/* let info = document.querySelector("#info") bilgileri yazdırdık */
